...
public class NhaXuatBanBLL {
    ...
    public static Object[] showControlWithCombobox(String cbbValue) throws ClassNotFoundException{
        ArrayList<NhaXuatBan> list = NhaXuatBanDAL.show();
    ...
    public static ComboBoxModel<?> cbb_show() throws ClassNotFoundException{
