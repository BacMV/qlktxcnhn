...
public class AdminUI extends javax.swing.JFrame {
    ...
    public void show_DeThi() throws SQLException, ClassNotFoundException{
        model = (DefaultTableModel) tbSach.getModel();
        tbSach.setModel(DeThiBLL.show()); 
        
        renderer.setHorizontalAlignment( JLabel.CENTER );
        tbSach.setDefaultRenderer(Object.class, renderer);
     
        cboMaTG1.setModel((ComboBoxModel<String>) TacGiaBLL.cbb_show());
        cboMaNXB1.setModel((ComboBoxModel<String>) NhaXuatBanBLL.cbb_show());
        
    }
    
    public void show_TacGia() throws SQLException, ClassNotFoundException{
    ...
    public void show_NhaXuatBan() throws ClassNotFoundException{
    ...
    public void show_TaiKhoanAdmin() throws ClassNotFoundException{
        tbTaiKhoan1.setModel(TaiKhoanBLL.show1());
        renderer.setHorizontalAlignment( JLabel.CENTER );
        tbTaiKhoan1.setDefaultRenderer(Object.class, renderer);
    }
    
    public void show_TaiKhoanUser() throws ClassNotFoundException{
    ...
    //Select row
    public void show_Row_tbSach() throws ClassNotFoundException{
        int i = tbSach.getSelectedRow();
        DeThi s = DeThiDAL.show().get(i);
    ...
    public void show_Row_tbTacGia() throws SQLException, ClassNotFoundException{
    ...
    public void show_Row_tbNXB() throws ClassNotFoundException{
    ...
    public void show_Row_tbTaiKhoanAdmin() throws ClassNotFoundException{
    ...
    public void show_Row_tbTaiKhoanUser() throws ClassNotFoundException{
    ...
    //    char[] password = passwordKH.getPassword();

        // Chuyển đổi mảng ký tự thành String
      //  String vanban = new String(password);

        // Tạo một đối tượng DES để mã hóa
     
        // Mã hóa văn bản sử dụng DES
	//	String vanbanMaHoa = baomat.encrypt(vanban);
       ...
       // tbD//SDaBan = new javax.swing.JTable();
       ...
       // tbH//HoaDon = new javax.swing.JTable();
        ...
        jLabel1.setText("Kho Lưu Đề Thi");
       ...
       jLabel9.setForeground(new java.awt.Color(0, 0, 162));
        ...
        tbSach.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Mã đề thi", "Tên sách", "Năm xuất bản", "Số trang", "Mã tác giả", "Tên tác giả", "Số câu hỏi", "Số lượng"
            }
        ));
        ...
        AdminTabPane.addTab("Kho Lưu Đề Thi", jPanel2);
        ...
        txtTenTG.setFont(new java.awt.Font("Segoe UI", 0, 18));
        txtTenTG.setFocusable(true);
        ...
        jLabel22.setText("Tài khoản giáo viên");
        ...
        jTabbedPane1.addTab("Giao vien", jPanel14);
        ...
        jLabel33.setText("Thay đổi mật khẩu tài khoản");
    ...
    private void btnLogOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogOutActionPerformed
        ...
        this.dispose();
        DangNhapUI dn = new DangNhapUI("Quản lý ");
        dn.showWindow();
    }//GEN-LAST:event_btnLogOutActionPerformed

    // Quản lý sách
    private void tbSachMouseClicked(java.awt.event.MouseEvent evt) throws ClassNotFoundException {//GEN-FIRST:event_tbSachMouseClicked
        // TODO add your handling code here:
        show_Row_tbSach();
    }//GEN-LAST:event_tbSachMouseClicked

    private void btnThemActionPerformed(java.awt.event.ActionEvent evt) throws ClassNotFoundException {//GEN-FIRST:event_btnThemActionPerformed
        // TODO add your handling code here:
        
        try{
            DeThi newBook = new DeThi();
            
            String vb = txtTenSach1.getText();
            String vb1 = txtMaSach1.getText();
      //    String vb2 = txtNamXB1.getText();
       //  String vb3 = txtSoTrang1.getText();
          // String vb4 = txtDonGia1.getText();
        //  String vb5 = txtSoLuongCon1.getText();
          ...
          newBook.setNamXuatBan(Integer.parseInt(txtNamXB1.getText()));
            ...
            newBook.setTenSach(DES.encrypt(vb));
            newBook.setMaSach(DES.encrypt(vb1));
            newBook.setMaTG(cboMaTG1.getSelectedItem().toString());
            newBook.setMaNXB(cboMaNXB1.getSelectedItem().toString());
       //  newBook.setNamXuatBan(Integer.parseInt(DES.encrypt(vb2)));
        //  newBook.setSoTrang(Integer.parseInt(DES.encrypt(vb3)));
            
        // newBook.setDonGia(Float.parseFloat(DES.encrypt(vb4)));
         //   newBook.setSoLuongCon(Integer.parseInt(DES.encrypt(vb5)));
        /*    String giaTriGiaiMa = DES.decrypt(vb);
            String giaTriGiaiMa1 = DES.decrypt(vb1);
            newBook.setTenSach(giaTriGiaiMa);
            newBook.setMaSach(giaTriGiaiMa1);*/
            try {
                try 
                {
					if(DeThiDAL.insert(DeThiDAL.show(),newBook)){
					    JOptionPane.showMessageDialog(null,"Thêm đề thành công!");
					    try {
					        show_DeThi();
    ...
    private void btnSuaActionPerformed(java.awt.event.ActionEvent evt) throws ClassNotFoundException {//GEN-FIRST:event_btnSuaActionPerformed
        // TODO add your handling code here:
        try{
            DeThi setBook = new DeThi();
            ...
            if (reply == JOptionPane.YES_OPTION) {
                try {
                    try {
						if(DeThiDAL.update(DeThiDAL.show(),setBook)){
						    JOptionPane.showMessageDialog(null,"Sửa đề thành công!");
						    try {
						        show_DeThi();
						    } catch (SQLException ex) {
						        Logger.getLogger(AdminUI.class.getName()).log(Level.SEVERE, null, ex);
						    ...
						    JOptionPane.showMessageDialog(null,"Mã đề không tồn tại!");
						}
					} catch (ClassNotFoundException e) {
						// TODO Auto-generated catch block
						e.printStackTrace();
            ...
            if(tbSach.getSelectedRow() == -1){
				...
				try {
					if(DeThiDAL.show().size() == 0){
					    ...
					    if (reply == JOptionPane.YES_OPTION) {
					        try {
					            DeThiDAL.delete(DeThiDAL.show(), delBook);
					        } catch (SQLException ex) {
					            Logger.getLogger(AdminUI.class.getName()).log(Level.SEVERE, null, ex);
					        }
					        model = (DefaultTableModel) tbSach.getModel();
    ...
    private void btnReset1ActionPerformed(java.awt.event.ActionEvent evt) throws ClassNotFoundException {//GEN-FIRST:event_btnReset1ActionPerformed
        try {
            // TODO add your handling code here:
            show_DeThi();
        } catch (SQLException ex) {
    ...
    //cài đặt bảng
    private void tbTacGiaMouseClicked(java.awt.event.MouseEvent evt) throws ClassNotFoundException {//GEN-FIRST:event_tbTacGiaMouseClicked
        try {
            // TODO add your handling code here:
            show_Row_tbTacGia();
        } catch (SQLException ex) {
    ...
    private void tbNXBMouseClicked(java.awt.event.MouseEvent evt) throws ClassNotFoundException {//GEN-FIRST:event_tbNXBMouseClicked
        // TODO add your handling code here:
        show_Row_tbNXB();
    ...
    private void tbTaiKhoan2MouseClicked(java.awt.event.MouseEvent evt) throws ClassNotFoundException {//GEN-FIRST:event_tbTaiKhoan2MouseClicked
        // TODO add your handling code here:
        show_Row_tbTaiKhoanUser();
    }//GEN-LAST:event_tbTaiKhoan2MouseClicked

    private void tbTaiKhoan1MouseClicked(java.awt.event.MouseEvent evt) throws ClassNotFoundException {//GEN-FIRST:event_tbTaiKhoan1MouseClicked
        // TODO add your handling code here:
    ...
    //Quản lý TacGia
    private void btnThem2ActionPerformed(java.awt.event.ActionEvent evt) throws ClassNotFoundException {//GEN-FIRST:event_btnThem2ActionPerformed
        // TODO add your handling code here:
        try{
            TacGia newTG = new TacGia();
            
            String vanban1 = txtMaTG1.getText();
            newTG.setMaTG(DES.encrypt(vanban1));
            String vanban2 = txtTenTG.getText();
            newTG.setTenTG(DES.encrypt(vanban2));
          /*  
            String giaima1 = DES.decrypt(vanban1);
            newTG.setMaTG(giaima1);
            String giaima2 = DES.decrypt(vanban2);
            newTG.setTenTG(giaima2);*/
    ...
    private void btnSua2ActionPerformed(java.awt.event.ActionEvent evt) throws ClassNotFoundException {//GEN-FIRST:event_btnSua2ActionPerformed
        // TODO add your handling code here:
        try{
           ...
           // setTacGia.setTenTG(txtTenTG.getText());
            ...
            String vanban1 = txtMaTG1.getText();
            setTacGia.setMaTG(DES.encrypt(vanban1));
            String vanban2 = txtTenTG.getText();
            setTacGia.setTenTG(DES.encrypt(vanban2));
    ...
    private void btnXoa2ActionPerformed(java.awt.event.ActionEvent evt) throws HeadlessException, ClassNotFoundException {//GEN-FIRST:event_btnXoa2ActionPerformed
        // TODO add your handling code here:
        try{
    ...
    //Quản lý NhaXuatBan
    private void btnThem3ActionPerformed(java.awt.event.ActionEvent evt) throws ClassNotFoundException {//GEN-FIRST:event_btnThem3ActionPerformed
        // TODO add your handling code here:
        try{
          ...
          // newNXB.setSDT(txtSDT.getText());
            String vanban1 = txtMaNXB1.getText();
            newNXB.setMaNXB(DES.encrypt(vanban1));
            String vanban2 =txtTenNXB1.getText();
        
            newNXB.setTenNXB(DES.encrypt(vanban2));
            String vanban3 = txtDiaChi.getText();
            newNXB.setDiaChi(DES.encrypt(vanban3));
           String vanban4 = txtSDT.getText();
            newNXB.setSDT(DES.encrypt(vanban4));
            
            
          /*  
            String giaima1 = DES.decrypt(vanban1);
            newNXB.setMaNXB(giaima1);
            String giaima2 = DES.decrypt(vanban2);
            newNXB.setTenNXB(giaima2);
            String giaima3 = DES.decrypt(vanban3);
            newNXB.setDiaChiNXB(giaima3);
            String giaima4 = DES.decrypt(vanban4);
            newNXB.setSDT(giaima4);
         */
    ...
    private void btnSua3ActionPerformed(java.awt.event.ActionEvent evt) throws ClassNotFoundException {//GEN-FIRST:event_btnSua3ActionPerformed
        // TODO add your handling code here:
        try{
            NhaXuatBan setNXB = new NhaXuatBan();
            String vanban5 = txtMaNXB1.getText();
            setNXB.setMaNXB(DES.encrypt(vanban5));
            String vanban6 =txtTenNXB1.getText();
            setNXB.setTenNXB(DES.encrypt(vanban6));
            String vanban7 = txtDiaChi.getText();
            setNXB.setDiaChi(DES.encrypt(vanban7));
            String vanban8 = txtSDT.getText();
            setNXB.setSDT(DES.encrypt(vanban8));
    ...
    private void btnXoa3ActionPerformed(java.awt.event.ActionEvent evt) throws HeadlessException, ClassNotFoundException {//GEN-FIRST:event_btnXoa3ActionPerformed
        // TODO add your handling code here:
        try{
    ...
    private void btnSuaTKActionPerformed(java.awt.event.ActionEvent evt) throws ClassNotFoundException {//GEN-FIRST:event_btnSuaTKActionPerformed
        // TODO add your handling code here:
        try{
			...
			String vanbanMaHoa = DES.encrypt(value);
			...
			@SuppressWarnings("unused")
			String vanbanMaHoa1 = DES.encrypt(confirmValue);

          
            setTK.setMatKhau(value);

            setTK.setVaiTro("Admin");
            if(vanbanMaHoa.equals(vanbanMaHoa1)){
                int reply = JOptionPane.showConfirmDialog(null, "Bạn có chắc chắn muốn sửa?", "Thông báo", JOptionPane.YES_NO_OPTION);
    ...
    private void btnThemtkUserActionPerformed(java.awt.event.ActionEvent evt) throws ClassNotFoundException {//GEN-FIRST:event_btnThemtkUserActionPerformed
        // TODO add your handling code here:
        try{
            TaiKhoan newTK = new TaiKhoan();
            newTK.setMaTaiKhoan(usernameKH.getText());
            char[] pf = passwordKH.getPassword();
            String vanban = new String(pf);
          
           // Chuyển đổi mảng ký tự thành String

          	@SuppressWarnings("unused")
			String vanbanMaHoa = DES.encrypt(vanban);
          	
          	/*
          	@SuppressWarnings("unused")
			String giaima = DES.decrypt(vanbanMaHoa);
            newTK.setMatKhau(giaima);
            */
           newTK.setMatKhau(vanbanMaHoa);
    ...
    private void delTkUserActionPerformed(java.awt.event.ActionEvent evt) throws HeadlessException, ClassNotFoundException {//GEN-FIRST:event_delTkUserActionPerformed
        // TODO add your handling code here:
        try{
            if(tbTaiKhoan2.getSelectedRow() == -1){
				...
				try {
					if(TaiKhoanDAL.showUser().size() == 0){
					    JOptionPane.showMessageDialog(rootPane,"Không có thông tin để xóa");
					}
					else{
...
//  String plainText = txtMatKhau.getText();  Get the text from the text field
//  DES.encrypt(plainText);  Pass the text to the encrypt method
//     char[] password = passwordKH.getPassword();
