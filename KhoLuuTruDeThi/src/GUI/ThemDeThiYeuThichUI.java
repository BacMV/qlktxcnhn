...
public class ThemDeThiYeuThichUI extends javax.swing.JFrame {

    
    public ThemDeThiYeuThichUI() {
        initComponents();
    }
    
    static DeThi newSach;
    
    public ThemDeThiYeuThichUI(String maTaiKhoan, DeThi sachDaChon, int soLuong) throws SQLException, ClassNotFoundException {
        initComponents();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Thông tin đề thi");
        ...
        jLabel7.setText("Thêm vào mục yêu thích");

        jLabel8.setFont(new java.awt.Font("Segoe UI", 0, 14)); // NOI18N
        jLabel8.setText("số câu hỏi");
    ...
    private void btnExit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExit1ActionPerformed
        try {
            ...
            Logger.getLogger(ThemDeThiYeuThichUI.class.getName()).log(Level.SEVERE, null, ex);
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ThemDeThiYeuThichUI.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ThemDeThiYeuThichUI().setVisible(true);
            }
        });
    }
