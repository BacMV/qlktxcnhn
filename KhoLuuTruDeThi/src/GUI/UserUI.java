...
public class UserUI extends javax.swing.JFrame {
    ...
    public void show_Sach(){
        ...
        try {
			tbSachUser.setModel(DeThiBLL.show());
		} catch (ClassNotFoundException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
    ...
    public void show_GioHang() throws SQLException, ClassNotFoundException{
        if(DeThiYeuThichDAL.show(DangNhapUI.username)!=null){
            model = (DefaultTableModel) tbGioHang.getModel();
        
        tbGioHang.setModel(DeThiYeuThichBLL.show(DangNhapUI.username));
        }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Kho Lưu Trữ Đề Thi");
        ...
        tbSachUser.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "STT", "Tên đề thi", "Năm xuất bản", "Số trang", "Tác giả", "Nhà xuất bản", "Số câu hỏi", "Số lượng còn"
            }
        ));
        ...
        btnThemVaoGio.setText("Thêm vào ");
        ...
        tabbedPane.addTab("Đề thi", jPanel2);
      ...
      tbGioHang.setModel(new javax.swing.table.DefaultTableModel(
        ...
        tabbedPane.addTab("Kho đề thi", jPanel3);
    ...
    private void btnLogOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnLogOutActionPerformed
        ...
        this.dispose();
        DangNhapUI dn = new DangNhapUI("Kho đề thi");
        dn.showWindow();
    }//GEN-LAST:event_btnLogOutActionPerformed

    private void userInfoActionPerformed(java.awt.event.ActionEvent evt) throws ClassNotFoundException {//GEN-FIRST:event_userInfoActionPerformed
        // TODO add your handling code here:
        this.dispose();
    ...
    private void btnThemVaoGioActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnThemVaoGioActionPerformed
        // TODO add your handling code here:
        try{
            DeThi s = DeThiDAL.GetSach(txtTenSachUser.getText());
            this.dispose();
            if(Integer.parseInt(txtSoLuong.getText()) <= s.getSoLuongCon()) {
                this.dispose();
                ThemDeThiYeuThichUI dn = new ThemDeThiYeuThichUI(DangNhapUI.username,s, Integer.parseInt(txtSoLuong.getText()));
                dn.showWindow();
            }
            else {
    ...
    private void btnSearchActionPerformed(java.awt.event.ActionEvent evt) throws ClassNotFoundException {//GEN-FIRST:event_btnSearchActionPerformed
        ...
        for(DeThi item:DeThiDAL.show()){
        	//string mahoa =txtSearchSach.getText();
        	String mahoa = txtSearchSach.getText();;
            if(item.getTenSach().equalsIgnoreCase(DES.encrypt(mahoa))){
