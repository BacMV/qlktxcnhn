...
public class TacGiaDAL {
    public static ArrayList<TacGia> show() throws SQLException, ClassNotFoundException{
        try{
    ...
    public static String GetTenTG(String maTG) throws SQLException, ClassNotFoundException{
    ...
    public static boolean insert(ArrayList<TacGia> list, TacGia a) throws IOException, SQLException, ClassNotFoundException{
        if(a.getMaTG().equals("")){
    ...
    public static boolean update(ArrayList<TacGia> list, TacGia a) throws IOException, SQLException, ClassNotFoundException{
        int index = -1;
        for(int i=0;i<list.size();i++)
    ...
    public static boolean delete(ArrayList<TacGia> list, TacGia a) throws IOException, SQLException, ClassNotFoundException{
        int index = -1;
        for(int i=0;i<list.size();i++)
            if(a.getMaTG().equals(list.get(i).getMaTG())){
                index = i;
