...
public class NhaXuatBanDAL {
    public static ArrayList<NhaXuatBan> show() throws ClassNotFoundException{
        try{
    ...
    public static String GetTenNXB(String maNXB) throws ClassNotFoundException{
    ...
    public static boolean insert(ArrayList<NhaXuatBan> list, NhaXuatBan a) throws IOException, SQLException, ClassNotFoundException{
    ...
    public static boolean update(ArrayList<NhaXuatBan> list, NhaXuatBan a) throws IOException, SQLException, ClassNotFoundException{
        int index = -1;
        for(int i=0;i<list.size();i++)
    ...
    public static boolean delete(ArrayList<NhaXuatBan> list, NhaXuatBan a) throws IOException, SQLException, ClassNotFoundException{
        int index = -1;
        for(int i=0;i<list.size();i++)
            if(a.getMaNXB().equals(list.get(i).getMaNXB())){
                index = i;
